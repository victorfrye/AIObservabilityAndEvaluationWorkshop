...
[UsedImplicitly]
[Lesson(2, 9, "NLP Evaluators", needsInput: true,
    informationalScreenTitle: "NLP Evaluators",
    informationalScreenMessage:
    "This lesson demonstrates the F1, BLEU (Bilingual Evaluation Understudy) and GLEU (Google's BLEU) Evaluators, which measure the similarity between generated text and reference text using n-gram precision. These are commonly used for machine translation evaluation.",
        ...
        EvaluationResult evaluationResult = await evaluator.EvaluateAsync(
            [
                new ChatMessage(ChatRole.System,
                    "You are a translation assistant translating inputs from English to French"),
