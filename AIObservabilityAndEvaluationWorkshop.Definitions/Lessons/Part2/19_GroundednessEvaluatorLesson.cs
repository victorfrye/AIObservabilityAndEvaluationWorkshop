...
[UsedImplicitly]
[Lesson(2, 19, "Groundedness Evaluator", needsInput: true,
    informationalScreenTitle: "Groundedness Evaluator",
    informationalScreenMessage:
    "This lesson demonstrates the Groundedness, Groundedness Pro, and Ungrounded Attributes Evaluators, which assess whether the AI's response is grounded in factual information and can be verified against source material. It helps detect hallucinations.",
...
public class GroundednessEvaluatorLesson(
    IServiceProvider sp,
    IChatClient chatClient,
    ILogger<GroundednessEvaluatorLesson> logger) : EvaluatorLessonBase(logger)
{
    protected override async Task<EvaluationResult> EvaluateAsync(string message)
    {
        ...
        EvaluationResult evaluationResult = await compositeEvaluator.EvaluateAsync(
            "Who was elected the 45th president of the United States?",
            message,
